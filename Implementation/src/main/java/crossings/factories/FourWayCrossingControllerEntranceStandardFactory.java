...
//
//    //Getter
//    public FourWayCrossingControllerEntranceStandard getFourWayCrossingControllerEntranceStandard(/*get params and save to fields*/, int secondsBetweenLaneSwitch) {
